...
if [ ! -d rtems ]; then
	git clone https://gitlab.rtems.org/rtems/rtos/rtems.git --recursive -b 6
	cd rtems
...
if [ ! -d rtems-net-services ]; then
	git clone https://gitlab.rtems.org/rtems/pkg/rtems-net-services.git --recursive --depth=1 -b 6
